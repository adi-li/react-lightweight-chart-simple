...
import { AreaSeries } from '../src/components/Series';
...
export default {
  title: 'Chart/AreaSeries',
  component: AreaSeries,
} as ComponentMeta<typeof AreaSeries>;

const Template: ComponentStory<typeof AreaSeries> = (args) => (
  <Chart height={300}>
    <AreaSeries {...args} />
  </Chart>
);
