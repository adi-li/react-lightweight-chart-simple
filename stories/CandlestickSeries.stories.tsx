...
import { CandlestickSeries } from '../src/components/Series';
...
export default {
  title: 'Chart/CandlestickSeries',
  component: CandlestickSeries,
} as ComponentMeta<typeof CandlestickSeries>;

const Template: ComponentStory<typeof CandlestickSeries> = (args) => (
  <Chart height={300}>
    <CandlestickSeries {...args} />
  </Chart>
);
